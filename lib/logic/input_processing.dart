...
String numberFormatter(String text) {
  // only keep allowed chars
  var result = text.split("").where((char) => Keys.all.contains(char)).join();
...
String numberSubmitter(String text) {
  // remove ending . or /
  text = text.removeAll(RegExp(r"\.+$|/+$"));
  // TODO empty numbers

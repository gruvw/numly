...
final favoriteGameIdsProvider = StreamProvider<Set<String>>(
  (ref) {
    final db = ref.watch(dbProvider);
...
final favoriteLevelIdsProvider = Provider<AsyncValue<Set<String>>>((ref) {
...
final favoriteTrainingsIdsProvider = Provider<AsyncValue<Set<String>>>((ref) {
  final favoriteGameIds = ref.watch(favoriteGameIdsProvider);
